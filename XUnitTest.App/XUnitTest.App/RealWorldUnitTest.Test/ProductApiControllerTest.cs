...
{
    // Web Uygulamasında bulunan Api controller daki action metodlar test ediliyor
    public class ProductApiControllerTest
    {
        ...
        /// <summary>
        /// 
        /// 2 Adet parametre verebiliriz ve metod 2 defa çalışmış olur
        /// 
        /// </summary>
        ...
        /// <summary>
        /// 
        /// PutProduct  Action'ındaki Update metodunun çalıştığını ve geriye NoContent döndüğünü test ettik
        /// 
        /// </summary>
        /// <param name="productId"></param>
        [Theory]
        ...
        public async void DeleteProduct_ActionExecute_ReturnNoContent(int productId)
        {
            ...
            _mockRepo.Verify(x => x.Delete(product), Times.Once);   // Delete metodunun çalışıp çalışmadığı kontrol edilir
